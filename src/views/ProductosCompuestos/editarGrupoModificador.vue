    ...
    <div class="modal-card">
      <div class="modal-header">
        <div class="modal-header-left">
          <div class="modal-icon"><Sliders :size="15" /></div>
          <span>Editar grupos modificadores</span>
        </div>
        <button class="close-btn" @click="$emit('cerrar')"><X :size="14" /></button>
      </div>
        ...
        <div class="split-layout">
          ...
          <div class="form-panel">
            ...
            <div class="fields">
              ...
              <div class="field-group">
                <label class="field-label">Modificador máximo</label>
                <input v-model="modifMax" type="number" class="field-input" />
              </div>
            </div>
